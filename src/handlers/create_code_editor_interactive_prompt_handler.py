...
from src.events.events import CodeEditorInteractivePromptCreated
from src.utils.llm import *


class CreateCodeEditorInteractivePromptHandler:
    """
    ...
    def handle(self) -> Prompt:
        ...
        return CodeEditorInteractivePromptCreated({
            **self.data,
            'promptId': prompt.id,
        })
    ...
    def _build_code_editor_interactive_prompt(self):
        ...
        count_of_type = f"one {self.interactive_type} shortcode"
