...
from src.events.events import GenerateSkillsResponseProcessed, InvalidGenerateSkillsResponseFromLLM, FailedToParseYamlFromGenerateSkillsResponse
...
class ProcessGenerateSkillsResponseHandler:
    ...
    def __trigger_completion_event(self, data: dict):
        EVENT_MANAGER.trigger(GenerateSkillsResponseProcessed(data))
