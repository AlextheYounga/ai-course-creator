...
class CreateCodepenInteractivesPromptHandler:
    ...
    def __init__(self, data: dict):
        ...
        self.next_events = []
        self.max_count = 2  # Generate maximum of 2 codepens per prompt
    ...
    def _build_codepen_interactive_prompt(self):
        ...
        codepen_count = self.data['interactives'][self.interactive_type]
        corrected_codepen_count = min(codepen_count, self.max_count)
        count_of_type = f"{corrected_codepen_count} {self.interactive_type} shortcode{'s' if corrected_codepen_count > 1 else ''}"
