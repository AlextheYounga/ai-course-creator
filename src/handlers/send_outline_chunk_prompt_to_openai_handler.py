...
from src.events.events import OutlineChunkResponseReceivedFromOpenAI
from src.utils.llm.get_llm_client import get_llm_client



class SendOutlineChunkPromptToOpenAIHandler:
    ...
    def handle(self):
        ...
        return OutlineChunkResponseReceivedFromOpenAI({
            **self.data,
