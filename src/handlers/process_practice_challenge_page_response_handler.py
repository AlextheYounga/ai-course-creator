...
from src.events.events import InvalidPracticeChallengePageResponseFromOpenAI, PracticeChallengePageResponseProcessedSuccessfully


class ProcessPracticeChallengePageResponseHandler:
    ...
    def handle(self) -> Outline:
        ...
        if not validated_response:
            ...
            return InvalidPracticeChallengePageResponseFromOpenAI(self.data)
        ...
        return PracticeChallengePageResponseProcessedSuccessfully(self.data)
