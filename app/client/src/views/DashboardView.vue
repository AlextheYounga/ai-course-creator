        ...
        <div class="xl:pl-72">
            ...
            <aside class="bg-black/10 lg:fixed lg:bottom-0 lg:right-0 lg:top-0 lg:w-96 lg:overflow-y-auto lg:border-l lg:border-white/5">
                ...
                <ul role="list" class="divide-y divide-white/5">
                    <!-- <li v-for="line in logLines" :key="line.name" class="px-4 py-4 sm:px-6 lg:px-8">
                        <p class="hidden mt-3 truncate text-sm text-gray-500">Initial Log Line</p>
                    </li> -->
                </ul>
            </aside>
        </div>
...
async function runCourseGenerator() {
    await flaskApi.post('/course-generator', {})
...
const commands = [
    { id: 1, name: 'Run Course Generator', method: runCourseGenerator },
]
